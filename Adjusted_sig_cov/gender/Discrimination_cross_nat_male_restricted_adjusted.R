...
gender_male_adjusted = function (data_ELSA, 
                                 data_HRS){
  
ELSAdiscrimination_data_wave5 = subset(ELSAdiscrimination_data_wave5_before_subsetting, ELSAdiscrimination_data_wave5_before_subsetting$w5sex_1_0 == 1)
HRS2010_discrimination_dataset = subset(HRS2010_discrimination_datase_before_subsetting, HRS2010_discrimination_datase_before_subsetting$sex_1_0 == 1)
...
ELSAdiscrimination_data_wave5$country = rep(1, times = 4569)
HRS2010_discrimination_dataset$country = rep(0, times = 9231)
...
print("check in code books that 1 and 0 in gender categories mean the same")
...
fm1_gender <- glm(discrimination_gender ~  age + sex + wealth, 
                  data = data_both_countries_gender_discrim)

fm2_gender <- glm(discrimination_gender ~  country_cat +  age + sex + wealth, 
                  data = data_both_countries_gender_discrim)



cross_country_OR = exp(cbind(OR = coef(fm2_gender), confint(fm2_gender)))


cross_country_OR_UK = cross_country_OR[2]
HRS_CI1_UK = cross_country_OR[7]
HRS_CI2_UK = cross_country_OR[12]


cross_country_OR_USA = cross_country_OR[1]
HRS_CI1_USA = cross_country_OR[6]
HRS_CI2_USA = cross_country_OR[11]



## various equivalent specifications of the LR test
gender_cross_national_diff = lrtest(fm1_gender, fm2_gender)

gender_chi_value_cross_national = gender_cross_national_diff$stats[1]

gender_pvalue_cross_national = gender_cross_national_diff$stats[3]
