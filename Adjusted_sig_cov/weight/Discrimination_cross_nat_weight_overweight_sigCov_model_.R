...
overweight_adjusted = function(data_ELSA,
                               data_HRS){
  
# BMI from wave 4 was used for subsetting the sample becuause there is no bmi at wave 5
ELSAdiscrimination_data_wave5 = subset(ELSAdiscrimination_data_wave5_before_subsetting,ELSAdiscrimination_data_wave5_before_subsetting$w4bmi_clean>25.0 & ELSAdiscrimination_data_wave5_before_subsetting$w4bmi_clean<=29.9)
HRS2010_discrimination_dataset = subset(HRS2010_discrimination_dataset_before_subsetting, HRS2010_discrimination_dataset_before_subsetting$HRS2010_BMI>25.0 & HRS2010_discrimination_dataset_before_subsetting$HRS2010_BMI<=29.9)
...
weight_results = rbind(cross_weight_findings)
