...
Financial_disc_adjusted_morethan_median_ALL= function(data_HRS, data_ELSA){
...
HRS_CI1_UK = cross_country_OR[9]
HRS_CI2_UK = cross_country_OR[16]


cross_country_OR_USA = cross_country_OR[1]
HRS_CI1_USA = cross_country_OR[8]
HRS_CI2_USA = cross_country_OR[15]
