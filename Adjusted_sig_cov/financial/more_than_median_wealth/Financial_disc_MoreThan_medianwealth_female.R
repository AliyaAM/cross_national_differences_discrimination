...
Financial_adjusted_moreThanMedian_female = function(data_ELSA,
                                         data_HRS){
...
ELSAdiscrimination_data_wave5 = subset(ELSAdiscrimination_data_wave5_before_subsetting, ELSAdiscrimination_data_wave5_before_subsetting$median_wealth_bin_ELSA == 2 & ELSAdiscrimination_data_wave5_before_subsetting$w5sex_1_0 == 0) 
HRS2010_discrimination_dataset = subset(HRS2010_discrimination_dataset_before_subsetting, HRS2010_discrimination_dataset_before_subsetting$meadian_wealth_bin_HRS == 2 & HRS2010_discrimination_dataset_before_subsetting$sex_1_0 == 0)
...
fm1_finacial <- glm(discrimination_financial ~ wealth, 
                    data = data_both_countries_financial_discrim)

fm2_finacial <- glm(discrimination_financial ~  country_cat   + wealth, 
                    data = data_both_countries_financial_discrim)
