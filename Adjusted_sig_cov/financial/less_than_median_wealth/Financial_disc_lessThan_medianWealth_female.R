...
Financial_adjusted_lessThan_medianWealth_female = function(data_HRS, data_ELSA){
...
ELSAdiscrimination_data_wave5 = subset(ELSAdiscrimination_data_wave5_before_subsetting, ELSAdiscrimination_data_wave5_before_subsetting$median_wealth_bin_ELSA == 1 & ELSAdiscrimination_data_wave5_before_subsetting$w5sex_1_0 == 0) 
HRS2010_discrimination_dataset = subset(HRS2010_discrimination_dataset_before_subsetting, HRS2010_discrimination_dataset_before_subsetting$meadian_wealth_bin_HRS == 1 & HRS2010_discrimination_dataset_before_subsetting$sex_1_0 == 0)
...
test_financial_ANDage  #sig for less than median wealth and male 
...
financial_covariates_model <- glm(HRS2010_reason_discrim1_reason_financial ~ continious_age, HRS2010_discrimination_dataset, family = binomial)
financial_covariates_model
summary(financial_covariates_model)

#ELSA glm 
ELSA_log_reg = glm(w5discrim_financial2 ~ w5married, data =ELSAdiscrimination_data_wave5)
...
fm1_finacial <- glm(discrimination_financial ~  age, 
                    data = data_both_countries_financial_discrim)

fm2_finacial <- glm(discrimination_financial ~  country_cat  + age, 
                    data = data_both_countries_financial_discrim)
...
summary(financial_cross_national_diff)
