...
HRS2010_discrimination_dataset_before_subsetting = read.csv("/Users/aliyaamirova/Documents/KCL_postDoc/Data_analysis/HRS_2010_data/HRS2010_discrimination_dataset_new.csv")
...
ELSAdiscrimination_data_wave5 = subset(ELSAdiscrimination_data_wave5_before_subsetting, ELSAdiscrimination_data_wave5_before_subsetting$median_wealth_bin_ELSA == 2) 
HRS2010_discrimination_dataset = subset(HRS2010_discrimination_dataset_before_subsetting, HRS2010_discrimination_dataset_before_subsetting$meadian_wealth_bin_HRS == 2)
...
test_financial_ANDeducation_level #sig for wealth > median  
...
financial_covariates_model <- glm(HRS2010_reason_discrim1_reason_financial ~ education_levels, HRS2010_discrimination_dataset, family = binomial)
financial_covariates_model
summary(financial_covariates_model)

#ELSA glm 
ELSA_log_reg = glm(w5discrim_financial2 ~ ELSA_Education, data =ELSAdiscrimination_data_wave5)
...
ELSAdiscrimination_data_wave5$country = rep(0, times = 1096)
HRS2010_discrimination_dataset$country = rep(1, times = 2065)
...
fm1_finacial <- glm(discrimination_financial ~  education, 
                    data = data_both_countries_financial_discrim)

fm2_finacial <- glm(discrimination_financial ~  country_cat  + education, 
                    data = data_both_countries_financial_discrim)
...
write.csv(financial_results, file = "/Users/aliyaamirova/Documents/KCL_postDoc/Data_analysis/Restricted_sig_cov_model_or/financial_discrimination_median_split_higherThanMedian_excludingWeatlthCov.csv")
