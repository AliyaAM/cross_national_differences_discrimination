...
Wcountry_adjusted_SES = function (data, 
                                    country, 
  ...
  if(covariate1 != "NA" & covariate2 != "NA" & covariate3 == "NA" &  covariate4 == "NA"){
    ...
    fm1 <- glm(discrimination ~ covariate1 + covariate2,  data = data_both_countries)
    
    fm2 <- glm(discrimination ~ SES +  covariate1 + covariate2, 
  ...
  if(covariate1 != "NA" & covariate2 != "NA" & covariate3 != "NA" & covariate4 == "NA"){
    ...
    fm1 <- glm(discrimination ~   covariate1 +  covariate2 +  covariate3,  data = data_both_countries)
    
    fm2 <- glm(discrimination ~ SES  +  covariate1 +  covariate2 +  covariate3, 
  ...
  if(covariate1 != "NA" & covariate2 != "NA" & covariate3 != "NA" & covariate4 != "NA"){
    ...
    fm1 <- glm(discrimination ~  covariate1  +  covariate2   +  covariate3    + covariate4,   data = data_both_countries)
    
    fm2 <- glm(discrimination ~ SES   +  covariate1  +  covariate2 +  covariate3 +  covariate4,   data = data_both_countries)
