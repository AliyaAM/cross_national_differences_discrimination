...
wealth_gradient_function = function (data_ELSA, 
  ...
  if(wealth_gradient_cov1 == "NA" & wealth_gradient_cov2 == "NA" & wealth_gradient_cov3 == "NA"){
    ...
    #wealth gradient 
    wealth_discrimination =  summary(glm(discrimination ~ scale(wealth), family = "binomial", data = data_both_countries))
    ...
    wealth_discrimination_ELSA =  summary(glm(discrimination ~ scale(wealth), family = "binomial", data = ELSA_subset_wealth_gradient))
    ...
    wealth_discrimination_HRS =  summary(glm(discrimination ~ scale(wealth), family = "binomial", data = HRS_subset_wealth_gradient))
  ...
  if(wealth_gradient_cov1 != "NA" & wealth_gradient_cov2 == "NA" & wealth_gradient_cov3 == "NA"){
    ...
    #wealth gradient 
    wealth_discrimination_adjusted =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]), 
    ...
    wealth_discrimination_ELSA_adjusted =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]), 
    ...
    wealth_discrimination_HRS_adjusted =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]), 
  ...
  if(wealth_gradient_cov1 != "NA" & wealth_gradient_cov2 != "NA" & wealth_gradient_cov3 == "NA"){
    ...
    #wealth gradient 
    wealth_discrimination_adjusted2 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]), 
                                                   family = "binomial", data = data_both_countries))
    ...
    wealth_discrimination_ELSA_adjusted2 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]), 
                                                        family = "binomial", data = ELSA_subset_wealth_gradient))
    ...
    wealth_discrimination_HRS_adjusted2 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]), 
                                                       family = "binomial", data = HRS_subset_wealth_gradient))
  ...
  if(wealth_gradient_cov1 != "NA" & wealth_gradient_cov2 != "NA" & wealth_gradient_cov3 != "NA"){
    ...
    #wealth gradient 
    wealth_discrimination_adjusted3 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]) + scale(data_both_countries[ ,   wealth_gradient_cov3]), 
                                                   family = "binomial", data = data_both_countries))
    ...
    wealth_discrimination_ELSA_adjusted3 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]) + scale(data_both_countries[ ,   wealth_gradient_cov3]), 
                                                        family = "binomial", data = ELSA_subset_wealth_gradient))
    ...
    wealth_discrimination_HRS_adjusted3 =  summary(glm(discrimination ~ scale(wealth) + scale(data_both_countries[ ,   wealth_gradient_cov1]) + scale(data_both_countries[ ,   wealth_gradient_cov2]) + scale(data_both_countries[ ,   wealth_gradient_cov3]),
                                                       family = "binomial", data = HRS_subset_wealth_gradient))
