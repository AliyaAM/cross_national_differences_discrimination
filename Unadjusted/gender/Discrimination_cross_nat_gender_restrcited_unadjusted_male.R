...
library(sjPlot)
library(knitr)
gender_restrcited_unadjusted_male = function(data_ELSA, 
                                             data_HRS){
  
ELSAdiscrimination_data_wave5 = subset(data_ELSA, data_ELSA$w5sex_1_0 == 1)
HRS2010_discrimination_dataset = subset(data_HRS, data_HRS$sex_1_0 == 1)
