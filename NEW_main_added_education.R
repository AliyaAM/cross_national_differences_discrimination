...
#ELSAdiscrimination_data_wave5_test = subset(ELSAdiscrimination_data_wave5_before_subsetting, ELSAdiscrimination_data_wave5_before_subsetting$w5limill == 1)
#unique(ELSAdiscrimination_data_wave5_test$education)
#HRS2010_discrimination_data_wave5_test = subset(HRS2010_discrimination_dataset_before_subsetting, HRS2010_discrimination_dataset_before_subsetting$limiting_condition_bin == 1)
#unique(HRS2010_discrimination_dataset_before_subsetting$education)
...
adjusted_cross_nat_disability_results = adjusted_cross_nat_comparison (data_ELSA = ELSAdiscrimination_data_wave5_before_subsetting, 
                                                                       ...
                                                                       covariate2 = "sex",
                                                                       covariate3 = "wealth",
                                                                       covariate4 = "NA", # we are setting this to NA becuase people with physical limitaitons in the HRS study did not provide data on this. 
...
write.csv(adjusted_results, file = paste(OUTPUT_ROOT, "Cross_nat_diff_adjusted_results_basic_adjustment_education.csv", sep=""))


Results_cross_nat = cbind(Unadjusted_results, adjusted_results)


write.csv(Results_cross_nat, file = paste(OUTPUT_ROOT, "Results_cross_nat_basic_adjustment_education.csv", sep=""))
...
write.csv(SES_adjusted_results, file = paste(OUTPUT_ROOT, "SES_adjusted_results_basic_adjustment_education.csv", sep=""))


SES_stratified_results = cbind(SES_unadjusted_results, SES_adjusted_results) 


write.csv(SES_stratified_results, file = paste(OUTPUT_ROOT, "SES_stratified_result_sv2_basic_adjustment_education.csv", sep=""))
...
Wcountry_adjusted_SES_sexuality_results = c(NA, 
                                               NA,
                                               NA, 
                                               NA,
                                               NA,
...
write.csv(Wcountry_adjusted_SES_results, file = paste(OUTPUT_ROOT, "Wcountry_adjusted_SES_results_basic_adjustment_education.csv", sep=""))
...
write.csv(Adjusted_cross_nat_Situations_results, file = paste(OUTPUT_ROOT, "Adjusted_cross_nat_Situations_result_basic_adjustment_education.csv", sep=""))
